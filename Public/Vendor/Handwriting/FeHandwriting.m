...
@implementation NSBezierPath (UIExt)
...
-(void) initLoadingShapeLayer
{
    ...
    _loadingShapeLayer.path = [loadingBezierpath quartzPathNeedClose:NO];
    _loadingShapeLayer.strokeEnd = 0;
    _loadingShapeLayer.strokeColor = [NSColor colorWithRed:26/255.0 green:167/255.0 blue:242/255.0 alpha:1.0].CGColor;
    ...
    _dotShapeLayer.path = [dotBezierPath quartzPathNeedClose:NO];
    _dotShapeLayer.strokeEnd = 0;
    _dotShapeLayer.strokeColor = [NSColor colorWithRed:26/255.0 green:167/255.0 blue:242/255.0 alpha:1.0].CGColor;
